    ...
    <div class="w-full max-w-md space-y-8">
      <div>
        <img class="mx-auto h-12 w-auto" src="https://tailwindui.com/img/logos/mark.svg?color=indigo&shade=600"
          alt="Your Company" />
        <h2 class="mt-6 text-center text-3xl font-bold tracking-tight text-gray-900">Better Finance</h2>
        <p class="mt-2 text-center text-sm text-gray-600">Acompanhe cotações e finanças</p>
      </div>
      <div class="mt-8 space-y-6">
        ...
        <div class="-space-y-px rounded-md shadow-sm">
          <div class="mb-2">
            ...
            <Input v-model="state.email" id="email-address" name="email" type="email" autocomplete="email" required=""
              placeholder="E-mail" />
          </div>
          <div>
        ...
        <div>
          <Button label="Entrar" @click="verifyLogin" :disabled="!canLogin || state.loading" />
        </div>
      </div>
